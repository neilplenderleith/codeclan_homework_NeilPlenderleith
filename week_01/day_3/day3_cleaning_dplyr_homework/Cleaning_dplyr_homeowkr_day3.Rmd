...
summary(movies)
view(movies)
# For Future reference - count NA values by column, arrange/count columns to determine 0 values, perhaps count chrater columns to determine if any are one or two length - these could be suspect
